...
public final class AI {
	...
	/**
	 * Non-null stand-in for "human player" in the setup-screen AI choice control.
	 * JavaFX does not reliably support {@code null} list items; real humans are represented by this
	 * value in the UI and excluded from the AI pool via {@link #isHumanUiPlaceholder(AI)}.
	 */
	private static final AI HUMAN_UI_PLACEHOLDER = fromName("Human", VisualiserType.NONE,
			HumanPlaceholderFactory.class);

	public static AI humanUiPlaceholder() {
		return HUMAN_UI_PLACEHOLDER;
	}

	public static boolean isHumanUiPlaceholder(AI ai) {
		return ai == HUMAN_UI_PLACEHOLDER;
	}
